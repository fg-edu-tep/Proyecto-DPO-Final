...
public class LearningPath {
    ...
    public Instant getFechaCreacionn() {
    ...
    public void notificarEstudianteDue(Estudiante ElEstudiante){
        ...
        Instant future = now.plusSeconds(2 * 24 * 60 * 60); // Avanzar dos días
        for (Actividad subAct : sinCompletar) {
            Instant dueDate = subAct.getDueDate();
            if (dueDate.isBefore(now) || dueDate.isBefore(future)) { // Si es hoy o en el futuro
    ...
    public Encuesta crearEncuesta(boolean obligatoria, String nombre, Instant fechaLimite, String descripcion, double calificacion, float rating, boolean esCompletada, ArrayList<Resenia> resenias, double nivelDificultad, boolean estaEmpezado, String tipo, ArrayList<PreguntaAbierta> preguntas) {
    ...
    // seguro el error es relacionado con super.
    public Examen crearExamen(boolean obligatoria, String nombre, Instant fechaLimite, String descripcion, double calificacion, float rating, boolean esCompletada, ArrayList<Resenia> resenias, double nivelDificultad, boolean estaEmpezado,String tipo, ArrayList<PreguntaAbierta> preguntas) {
    ...
    // seguro el error es relacionado con super.
    public Quiz crearQuiz( boolean obligatoria, String nombre, Instant fechaLimite, String descripcion, double calificacion, float rating, boolean esCompletada, ArrayList<Resenia> resenias, double nivelDificultad, boolean estaEmpezado, String tipo, ArrayList<PreguntaCerrada> preguntas) {
    ...
    public RecursoEducativo crearRecursoEd( boolean obligatoria, String nombre, Instant fechaLimite, String descripcion, double calificacion, float rating, boolean esCompletada, ArrayList<Resenia> resenias, double nivelDificultad, boolean estaEmpezado, String tipo, String contenido, String tipoC) {
    ...
    public Tarea crearTarea( boolean obligatoria, String nombre, Instant fechaLimite, String descripcion, double calificacion, float rating, boolean esCompletada, ArrayList<Resenia> resenias, double nivelDificultad, boolean estaEmpezado, String tipo) {
